...
class ClassCreatorCommand extends Command
{
    ...
    public function fire()
    {
        ...
        $roleModel       = Config::get('astro.role');
        $permissionModel = Config::get('astro.permission');
    ...
    {
        $data   = compact('class');
        $output = $this->laravel->view->make('astro::generators.class')->with($data)->render();
