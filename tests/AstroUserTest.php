...
use Mockery as m;
use Roketin\Astro\Contracts\AstroUserInterface;
use Roketin\Astro\Traits\AstroUserTrait;

class AstroUserTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testRoles()
    {
        ...
        Config::shouldReceive('get')->once()->with('astro.role')
            ->andReturn('role_table_name');
        Config::shouldReceive('get')->once()->with('astro.role_user_table')
            ->andReturn('assigned_roles_table_name');
        Config::shouldReceive('get')->once()->with('astro.user_foreign_key')
            ->andReturn('user_id');
        Config::shouldReceive('get')->once()->with('astro.role_foreign_key')
            ->andReturn('role_id');
    ...
    public function testHasRole()
    {
        ...
        |------------------------------------------------------------
         */
        Config::shouldReceive('get')->with('astro.role_user_table')->times(9)->andReturn('role_user');
    ...
    public function testCan()
    {
        ...
        Config::shouldReceive('get')->with('astro.role_user_table')->times(11)->andReturn('role_user');
    ...
    public function testCanWithPlaceholderSupport()
    {
        ...
        Config::shouldReceive('get')->with('astro.role_user_table')->times(6)->andReturn('role_user');
    ...
    public function testAbilityShouldReturnBoolean()
    {
        ...
        Config::shouldReceive('get')->with('astro.role_user_table')->times(32)->andReturn('role_user');
    ...
    public function testAbilityShouldAcceptStrings()
    {
        ...
        Config::shouldReceive('get')->with('astro.role_user_table')->times(8)->andReturn('role_user');
    ...
    public function testDetachAllRoles()
    {
        ...
        |------------------------------------------------------------
         */
        Config::shouldReceive('get')->with('astro.role')->once()->andReturn('App\Role');
        Config::shouldReceive('get')->with('astro.role_user_table')->once()->andReturn('role_user');
        Config::shouldReceive('get')->with('astro.user_foreign_key')->once()->andReturn('user_id');
        Config::shouldReceive('get')->with('astro.role_foreign_key')->once()->andReturn('role_id');
    ...
    {
        $permMock               = m::mock('Roketin\Astro\Permission');
    ...
    {
        $roleMock              = m::mock('Roketin\Astro\Role');
...
class HasRoleUser implements AstroUserInterface
{
    use AstroUserTrait;
