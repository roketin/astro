...
use Mockery as m;
use Roketin\Astro\Astro;

class AstroTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testHasRole()
    {
         ...
         */
        $app   = new stdClass();
        $astro = m::mock('Roketin\Astro\Astro[user]', [$app]);
        ...
        |------------------------------------------------------------
         */
        $this->assertTrue($astro->hasRole('UserRole'));
        $this->assertFalse($astro->hasRole('NonUserRole'));
        $this->assertFalse($astro->hasRole('AnyRole'));
    }
    ...
    public function testCan()
    {
        ...
        |------------------------------------------------------------
         */
        $this->assertTrue($astro->can('user_can'));
        $this->assertFalse($astro->can('user_cannot'));
        $this->assertFalse($astro->can('any_permission'));
    }
    ...
    public function testUser()
    {
        ...
        |------------------------------------------------------------
         */
        $this->assertSame($user, $astro->user());
    }
    ...
    public function testRouteNeedsRole()
    {
        ...
        |------------------------------------------------------------
         */
        $astro->routeNeedsRole($route, $oneRole);
        $astro->routeNeedsRole($route, $manyRole);
    }
    ...
    public function testRouteNeedsPermission()
    {
        ...
        |------------------------------------------------------------
         */
        $astro->routeNeedsPermission($route, $onePerm);
        $astro->routeNeedsPermission($route, $manyPerm);
    }
    ...
    public function testRouteNeedsRoleOrPermission()
    {
        ...
        |------------------------------------------------------------
         */
        $astro->routeNeedsRoleOrPermission($route, $oneRole, $onePerm);
        $astro->routeNeedsRoleOrPermission($route, $oneRole, $manyPerm);
        $astro->routeNeedsRoleOrPermission($route, $manyRole, $onePerm);
        $astro->routeNeedsRoleOrPermission($route, $manyRole, $manyPerm);
    }
    ...
    protected function filterTestExecution($methodTested, $mockedMethod, $returnValue, $filterTest, $abort, $expectedResponse)
    {
        ...
        $app->router = m::mock('Route');
        $astro       = m::mock("Roketin\Astro\Astro[$mockedMethod]", [$app]);
        ...
        $astro->shouldReceive($mockedMethod)->with($methodValue, m::any(true, false))->andReturn($returnValue)->once();
        $astro->$methodTested($route, $methodValue, $expectedResponse);
    }
    ...
    public function testFilterGeneratedByRouteNeedsRoleOrPermission(
        ...
        $app         = m::mock('Illuminate\Foundation\Application');
        $app->router = m::mock('Route');
        $astro       = m::mock('Roketin\Astro\Astro[hasRole, can]', [$app]);
        ...
        $astro->shouldReceive('hasRole')->with($roleName, $requireAll)->andReturn($roleIsValid)->once();
        $astro->shouldReceive('can')->with($permName, $requireAll)->andReturn($permIsValid)->once();
        ...
        $astro->routeNeedsRoleOrPermission($route, $roleName, $permName, $expectedResponse, $requireAll);
    }
